<?php 
	...
	$raza = $_GET['raza'];
	$edad = $_GET['edad'];
	$vacunado = $_GET['vacunado'];
	$chip = $_GET['chip'];
	$genero = $_GET['genero'];

	$sql = "SELECT * FROM animales where nombre=$nombre OR tipo=$tipo OR raza=$raza OR edad=$edad OR vacunado=$vacunado OR chip=$chip OR genero=$genero;";
